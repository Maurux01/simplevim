return {
  {
    ...
    config = function()
      ...
      ls.add_snippets("javascriptreact", {
        s("rfc", { t("const "), i(1, "Component"), t({" = () => {", "  return (", "    <div>", "      "}), i(2), t({"\n", "    </div>", "  );
"}), f(function(args) return args[1][1] end, {1}), t(";") }),
        s("rfce", { t("import React from 'react';"), t({"\n\nconst ", "  "}), i(1, "Component"), t({" = () => {", "  return (", "    <div>", "      "}), i(2), t({"\n", "    </div>", "  );
"}), f(function(args) return args[1][1] end, {1}), t(";") }),
        s("use", { t("const ["), i(1, "state"), t(", set"), f(function(args) return args[1][1]:gsub("^%l", string.upper) end, {1}), t("] = useState("), i(2), t(");") }),
        s("ue", { t("useEffect(() => {"), t({"\n", "  "}), i(1), t({"\n"}, ["}), i(2), t("]);") }),
        s("uc", { t("const "), i(1, "value"), t(" = useCallback(() => {"), t({"\n", "  "}), i(2), t({"\n"}, ["}), i(3), t("]);") }),
        s("um", { t("const "), i(1, "value"), t(" = useMemo(() => {"), t({"\n", "  return "}), i(2), t({"\n"}, ["}), i(3), t("]);") }),
      ...
      ls.add_snippets("typescriptreact", {
        s("rfc", { t("interface "), i(1, "Component"), t("Props {"), t({"\n", "  "}), i(2), t({"\n", "}", "\nconst ", "  "}), f(function(args) return args[1][1] end, {1}), t(": React.FC<"), f(function(args) return args[1][1] end, {1}), t("Props> = ("), i(3), t({") => {", "  return (", "    <div>", "      "}), i(4), t({"\n", "    </div>", "  );
"}), f(function(args) return args[1][1] end, {1}), t(";") }),
      })

      -- Python
      ls.add_snippets("python", {
        s("def", { t("def "), i(1, "function_name"), t("("), i(2), t("):"), t({"\n", "    "}), i(0) }),
        s("class", { t("class "), i(1, "ClassName"), t(":"), t({"\n", "    def __init__(self"}), i(2), t("): "), t({"\n", "        "}), i(0) }),
        s("if", { t("if "), i(1, "condition"), t(":"), t({"\n", "    "}), i(0) }),
        s("elif", { t("elif "), i(1, "condition"), t(":"), t({"\n", "    "}), i(0) }),
        s("else", { t({"else:", "    "}), i(0) }),
        s("for", { t("for "), i(1, "item"), t(" in "), i(2, "iterable"), t(":"), t({"\n", "    "}), i(0) }),
        s("while", { t("while "), i(1, "condition"), t(":"), t({"\n", "    "}), i(0) }),
        s("try", { t({"try:", "    "}), i(1), t({"\n"}), t("except "), i(2, "Exception"), t({" as e:", "    "}), i(3, "pass") }),
        s("with", { t("with "), i(1), t(" as "), i(2), t(":"), t({"\n", "    "}), i(0) }),
      ...
      ls.add_snippets("php", {
        ...
        s("foreach", { t("foreach ($"), i(1, "array"), t(" as $"), i(2, "item"), t(") {"), t({"\n", "    "}), i(0), t({"\n", "}"}) }),
        s("if", { t("if ("), i(1, "condition"), t(") {"), t({"\n", "    "}), i(0), t({"\n", "}"}) }),
...
<head>", "    <meta charset=\"UTF-8\">
    ...
    <title>"}), i(1, "Document"), t({"</title>", "</head>", "<body>", "    "}), i(0), t({"\n", "</body>", "</html>"}) }),
      ...
      ls.add_snippets("lua", {
        ...
        s("func", { t("local function "), i(1, "name"), t("("), i(2), t(")"), t({"\n", "  "}), i(0), t({"\n", "end"}) }),
        s("if", { t("if "), i(1, "condition"), t({" then", "  "}), i(0), t({"\n", "end"}) }),
        s("for", { t("for "), i(1, "i"), t(" = 1, "), i(2, "10"), t({" do", "  "}), i(0), t({"\n", "end"}) }),
        s("forp", { t("for "), i(1, "k"), t(", "), i(2, "v"), t(" in pairs("), i(3, "table"), t({") do", "  "}), i(0), t({"\n", "end"}) }),
        s("fori", { t("for "), i(1, "i"), t(", "), i(2, "v"), t(" in ipairs("), i(3, "table"), t({") do", "  "}), i(0), t({"\n", "end"}) }),
        s("while", { t("while "), i(1, "condition"), t({" do", "  "}), i(0), t({"\n", "end"}) }),
      ...
      ls.add_snippets("typescript", {
        ...
        s("ngfor", { t("*ngFor=\"let "), i(1, "item"), t(" of "), i(2, "items"), t(\" :key=\"", i(3, "item.id"), t("\"") }),
      })

      -- Vue.js
      ls.add_snippets("vue", {
        s("template", { t({"<template>", "  <div>", "    "}), i(1), t({"\n", "  </div>", "</template>", "", "<script>", "export default {", "  name: '"}), i(2, "Component"), t({"',", "  "}), i(0), t({"\n", "}", "</script>", "", "<style scoped>", "</style>"}) }),
      ...
      ls.add_snippets("javascript", {
        ...
        s("express", { t({"const express = require('express');", "const app = express();", "", "app.get('/', (req, res) => {", "  res.send('Hello World!');", "});", "", "app.listen("}), i(1, "3000"), t(", () => {"), t({"\n", "  console.log('Server running on port "), f(function(args) return args[1][1] end, {1}), t({"');", "});"}) }),
      })
      
      -- Bash/Shell (Epic snippets)
      ls.add_snippets("sh", {
        s("shebang", { t("#!/bin/bash"), t({"\n", "set -euo pipefail", "\n"}), i(0) }),
        s("strict", { t({"set -euo pipefail", "IFS=$'\n\t'"}) }),
        s("if", { t("if [[ "), i(1, "condition"), t({" ]]; then", "  "}), i(2), t({"\n", "fi"}) }),
        s("elif", { t("elif [[ "), i(1, "condition"), t({" ]]; then", "  "}), i(0) }),
        s("for", { t("for "), i(1, "item"), t(" in "), i(2, "${array[@]}"), t({"; do", "  "}), i(3), t({"\n", "done"}) }),
        s("while", { t("while [[ "), i(1, "condition"), t({" ]]; do", "  "}), i(2), t({"\n", "done"}) }),
        s("func", { t(""), i(1, "function_name"), t({"() {", "  local "}), i(2, "param"), t("=$1"), t({"\n", "  "}), i(3), t({"\n", "}"}) }),
        s("case", { t("case $"), i(1, "var"), t({" in", "  "}), i(2, "pattern1"), t({")", "    "}), i(3, "echo \"Option 1\""), t({"\n    ;;", "  "}), i(4, "pattern2"), t({")", "    "}), i(5, "echo \"Option 2\""), t({"\n    ;;", "  *)", "    echo \"Unknown: $"}), f(function(args) return args[1][1] end, {1}), t({"\"", "    ;;", "esac"}) }),
        s("array", { t(""), i(1, "array"), t("=("), i(2), t(")") }),
        s("read", { t("read -p \""), i(1, "Enter value: "), t(\" \""), i(2, "variable") }),
        s("readyn", { t({"read -p \"", "  "}), i(1, "Continue? (y/n): "), t({"\" yn", "case $yn in", "  [Yy]*) ", "  "}), i(2), t({"echo \"Yes\"", " ;;", "  [Nn]*) ", "  "}), i(3), t({"echo \"No\"; exit 1", " ;;", "  *) echo \"Please answer yes or no.\" ;;", "esac"}) }),
        s("getopts", { t("while getopts \""), i(1, "h:v"), t(\"" opt; do", "  case $opt in", "    h) echo \"Help\" ;;", "    v) echo \"Version\" ;;", "    \?) echo \"Invalid option\" >&2; exit 1 ;;", "  esac", "done"}) }),
        s("check", { t("if [[ ! -"), i(1, "f"), t(" "), i(2, "file"), t({" ]]; then", "  echo \"Error: File not found\" >&2", "  exit 1", "fi"}) }),
        s("exists", { t("[[" ), i(1, "f"), t(" "), i(2, "file"), t(" ]]") }),
        s("empty", { t("[[" ), i(1, "z $variable"), t(" ]]") }),
        s("nonempty", { t("[[" ), i(1, "n $variable"), t(" ]]") }),
        s("numeric", { t("[[" ), i(1, "$var =~ ^[0-9]+$"), t(" ]]") }),
        ...
        s("debug", { t("[[" ), i(1, "$DEBUG"), t("]] && echo \"DEBUG: "), i(2, "message"), t(\"" ) }),
        ...
        s("lock", { t("LOCKFILE=\"/tmp/"), i(1, "script"), t(".lock\"", "\nif [[ -f $LOCKFILE ]]; then", "  echo \"Script already running\" >&2", "  exit 1", "fi", "touch $LOCKFILE", "trap 'rm -f $LOCKFILE' EXIT"}) }),
        s("config", { t("CONFIG_FILE=\"", i(1, "config.conf"), t(\"\"", "\n[[ -f $CONFIG_FILE ]] && source $CONFIG_FILE") }),
